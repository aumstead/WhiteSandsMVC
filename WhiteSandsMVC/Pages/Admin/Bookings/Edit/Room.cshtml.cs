...
namespace WhiteSandsMVC.Pages.Admin.Bookings.Edit
{
    ...
    public class RoomModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            if (ModelState.IsValid)
            {
                ...
                bookingObj.Adults = Input.Adults;
                bookingObj.Children = Input.Children;
                bookingObj.Status = Input.Status;
                bookingObj.Notes = Input.Notes;

                _unitOfWork.Booking.Update(bookingObj);

                return RedirectToPage("/Admin/Bookings/details", new { id = Input.BookingId });
            }
